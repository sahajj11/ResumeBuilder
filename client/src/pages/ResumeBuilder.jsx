  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-6'>
        <Link to={'/app'} className='inline-flex gap-2 items-center text-slate-500 transition-all'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${activeSectionIndex === sections.length - 1 && 'opacity-50'}`}
              ...
              <div className='space-y-6'>
                {activeSection.id === 'personal' && resumeData?.personal_info && (
                  <PersonalInfoForm
                ...
                {activeSection.id === 'summary' && (
                  <ProfessionalSummaryForm setResumeData={setResumeData} onChange={(data)=>setResumeData(prev =>({...prev,professional_summary:data}))} data={resumeData.professional_summary} />
                )}
              ...
              <button onClick={()=>{toast.promise(saveResume,{loading:"Saving ..."})}} className='ring-green-300 transition-all rounded-md px-6 py-2 mt-6 text-sm text-green-600 ring hover:ring-green-400 bg-gradient-to-r from-green-100 to-green-200'>
                Save Changes
              </button>
            </div>
          </div>
